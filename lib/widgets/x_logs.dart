...
import 'package:xkit/extension/x_widget_ext.dart';
import 'package:xkit/helper/x_logger.dart';
import 'package:xkit/widgets/x_environment.dart';

class XLogListPage extends StatefulWidget {
  const XLogListPage({super.key});

  @override
  State<XLogListPage> createState() => _XLogListPageState();
}

class _XLogListPageState extends State<XLogListPage> {
  bool _reverse = false;
  ...
  void _openEnvironmentSwitchPage() {
    // 跳转到环境切换页面
    Navigator.push(context, MaterialPageRoute(builder: (context) => const XEnvironmentPage()));
  }
