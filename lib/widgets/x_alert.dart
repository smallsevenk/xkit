...
class XAlert {
  static final _defaultTitleStyle = TextStyle(fontSize: 36.sp, color: Colors.white);
  ...
  static final _defaultConfirmStyle = TextStyle(
    color: Color(0xFFFF6335),
    fontSize: 34.sp,
    fontWeight: FontWeight.w600,
  );

  static final List<Color> _defaultConfirmBackgroundColors = [Color(0xFFFFEB98), Color(0xFFCAAB62)];
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Divider(height: 1.w, color: Color(0xFFE5E5E5)),
  ...
  Widget _buildActionButtons(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        if (showCancel) Container(width: 1.w, height: 88.w, color: Color(0xFFE5E5E5)),
